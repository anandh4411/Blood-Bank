...
<body>
                ...
                <div class="container">
                    ...
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            if (isset($_SESSION['reciever-name'])){
                                echo 
                                '<li>
                                ...
                                echo '<li>
                                        <a href="../../pages/reciever-login.html">Login</a>
                                      </li>';
                            }
                ...
                <div class="slider-content text-center">
                    <div class="container">
                        ...
                        <div class="slider-contents-info">
                            ...
                            <a href="#recieve" class="btn btn-slider">Recieve Blood Now <i
                ...
                <div class="slider-content text-center">
                    <div class="container">
                        <div class="slider-contents-info">
                            ...
                            <a href="#recieve" class="btn btn-slider">Join With Us <i class="fa fa-long-arrow-right"></i></a>
                        </div><!-- /.slider-content -->
                    </div> <!-- end .slider-contents-info  -->
                </div>
    ...
    <section id="recieve" class="section-appointment">
            ...
            <div class="row">
                ...
                <div id="register" class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div class="appointment-form-wrapper text-center clearfix">
                        ...
                        <form action="reciever-register.php" method="post" class="appoinment-form">
                            ...
                            <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                <button id="btn_submit" class="btn-submit" type="submit">Ready to recieve</button>
                            </div>
